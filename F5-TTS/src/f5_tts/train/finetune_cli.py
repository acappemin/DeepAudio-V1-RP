...
def parse_args():
    ...
    parser.add_argument("--dataset_name", type=str, default="v2c", help="Name of the dataset to use")
...
def main():
    ...
    if args.finetune:
        ...
        if not os.path.isfile(file_checkpoint):
            ...
            print("copy checkpoint for finetune", ckpt_path, file_checkpoint)
...
####CUDA_VISIBLE_DEVICES=0 python src/f5_tts/train/finetune_cli.py --finetune --logger wandb --log_samples --learning_rate 0.00001 --dataset_name v2c --pretrain /ailab-train/speech/zhanghaomin/codes3/F5-TTS-main/ckpts/v2c/model_4906.pt
