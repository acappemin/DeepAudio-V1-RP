        ...
        for epoch in range(skipped_epoch, self.epochs):
            ...
            for idx, batch in enumerate(current_dataloader):
                with self.accelerator.accumulate(self.model):
                    ...
                    energy = batch["energy"].permute(0, 2, 1)
                    ...
                    loss, cond, pred = self.model(
                        mel_spec, text=text_inputs, lens=mel_lengths, noise_scheduler=self.noise_scheduler, energy=energy
                    )
                ...
                if idx == len(current_dataloader) - 1 and self.accelerator.sync_gradients:
                    ...
                    if self.log_samples and self.accelerator.is_local_main_process:
                        ...
                        with torch.inference_mode():
                            generated, _ = self.accelerator.unwrap_model(self.model).sample(
                                ...
                                energy=torch.cat([energy[0:1,:ref_audio_len,:], energy[0:1,:ref_audio_len,:]], dim=1)
                            )
            ...
            print("loss train", N, loss_train/N)  # 0.7178764853776838 0.7137135510487407
